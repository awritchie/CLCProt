...
function clcprot:SOV_COMBAT_LOG_EVENT_UNFILTERED(event, timestamp, combatEvent, hideCaster, sourceGUID, sourceName, sourceFlags, sourceRaidFlags, destGUID, destName, destFlags, destRaidFlags, spellId, spellName, spellSchool, spellType, dose, ...)
	if sourceName == playerName then
		if spellId == sovId then
			...
			elseif combatEvent == "SPELL_DAMAGE" and refreshers[spellId] then
				self:Sov_SPELL_AURA_REFRESH(destGUID, destName)
			end
		end
	end
