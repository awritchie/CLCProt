...
if select(7,GetSpellInfo("Empowered Hammer of Wrath")) then
	howId 				= 158392	-- Empowered hammer of wrath
	end
...
-- status vars
local s1, s2
local s_ctime, s_otime, s_gcd, s_hp, s_dp, s_ha, s_aw, s_ss, s_4t15, s_4t16, s_haste, s_targetType, s_fv
local s_exoId = exoId
...
local actions = {	
	tv5 = {
		...
		UpdateStatus = function()
			...
			local talentID, talentname, _, talentselected = GetTalentInfo(7, 3, GetActiveSpecGroup())
			if talenselected then
				s_fv = 30
			end			
		end,
	...
	tvdpD3 = {
		id = tvId,
		GetCD = function()
			if s_dp > 0.1 and s_dp < 3 then return 0 end
			return 100
		end,
		UpdateStatus = function()
			s_ctime = s_ctime + s_gcd + 1.5
	...
	edsD3 = {
		id = dsId,
		GetCD = function()
			if ( s_4t16 > 0 and s_4t16 < 3 ) then return 0 end
			return 100
		end,
		UpdateStatus = function()
			s_ctime = s_ctime + s_gcd + 1.5
	...
	edsfv = {
		id = dsId,
		GetCD = function()
			if ( s_4t16 > 0 and s_fv > 0 ) then return 0 end
			return 100
		end,
		UpdateStatus = function()
			s_ctime = s_ctime + s_gcd + 1.5
	...
	edsfv5 = {
		id = dsId,
		GetCD = function()
			if ( (s_4t16 > 0) and (s_hp >= 5)  and s_fv > 0 ) then return 0 end
			return 100
		end,
		UpdateStatus = function()
			s_ctime = s_ctime + s_gcd + 1.5
	...
	fv = { 
		...
		GetCD = function()
			local talentID, talentname, _, talentselected = GetTalentInfo(7, 3, GetActiveSpecGroup())
			if (s_hp >= 3 or s_dp > 0.1 and talentselected) then return 0 end
			return 100
		end,
		UpdateStatus = function()
			s_ctime = s_ctime + s_gcd + 1.5
...
local function GetStatus()
	...
	s_fv = CheckBuffDuration("player","Final Verdict")
